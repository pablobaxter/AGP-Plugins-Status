...
- :green_heart: Fixed
- :yellow_square: Broken, with workaround
- :red_circle: Broken, no workaround
...
| `com.squareup.wire` | :green_heart: Fixed (6.0.0-alpha02) | https://github.com/square/wire/issues/3371 | `android.enableLegacyVariantApi=true` | Fixed in https://github.com/square/wire/pull/3504 |
...
| `org.gradle.android.cache-fix` | :green_heart: Fixed (3.0.2) | https://github.com/gradle/android-cache-fix-gradle-plugin/issues/447 | `android.newDsl=false` | Addressed by https://github.com/gradle/android-cache-fix-gradle-plugin/pull/1894. Requires >= AGP 9.0.0-alpha06 | |
...
| `dev.icerock.mobile.multiplatform-resources` | :green_heart: Fixed (0.26.0) | https://github.com/icerockdev/moko-resources/issues/820<br>https://github.com/icerockdev/moko-resources/issues/852 | <pre>android.builtInKotlin=false<br>android.newDsl=false<br>android.sourceset.disallowProvider=false</pre> | Still incompatiable with tests, see https://github.com/icerockdev/moko-resources/issues/860 |
...
| `org.sonarqube` | :yellow_square: Broken | | `android.newDsl=false` | Addressed by https://community.sonarsource.com/t/working-towards-the-support-of-android-gradle-plugin-9/177015 |
